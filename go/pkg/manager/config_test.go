...
func TestLoadConfig(t *testing.T) {
	...
	os.Setenv("HYPER_API_KEY", "abc")
	os.Setenv("HYPER_API_SECRET", "def")
	t.Cleanup(func() {
		os.Unsetenv("HYPER_API_KEY")
		os.Unsetenv("HYPER_API_SECRET")
	})
...
`
	...
	if cfg.Exchanges["hyperliquid"].APIKey != "abc" {
		t.Fatalf("APIKey not expanded: %s", cfg.Exchanges["hyperliquid"].APIKey)
	}
